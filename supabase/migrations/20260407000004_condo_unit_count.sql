-- Phase A: Condo deduplication
-- Add condo_unit_count to exemptions (non-null means this is a condo parent lot)
ALTER TABLE exemptions
  ADD COLUMN IF NOT EXISTS condo_unit_count INT;

-- Rebuild property_pipeline view to expose condo_unit_count
